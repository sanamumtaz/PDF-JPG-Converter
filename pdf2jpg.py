...
def create_Toplevel1(rt, *args, **kwargs):
    ...
    w = tk.Toplevel (root)
    top = Toplevel1 (w)
    pdf2jpg_support.init(w, top, *args, **kwargs)
    return (w, top)
...
class Toplevel1:
    def __init__(self, top=None):
        ...
        self.Button1.configure(text='''JPG → PDF''')
        ...
        self.Label2.configure(text='''Convert PDF to JPG''')
        ...
        self.Button2.configure(command=pdf2jpg_support.select_file)
        ...
        self.Button3.configure(command=pdf2jpg_support.convert2jpg)
        self.Button3.configure(text='''Convert to JPG''')
